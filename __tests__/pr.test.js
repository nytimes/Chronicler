...
test('getReleasesUrl returns the url for the github repo releases endpoint', t => {
  const expected =
    'https://api.github.com/repos/nytm/trex-release-drafts/releases?access_token=MOCK_TOKEN'
...
test('getSingleReleaseUrl returns the github release url for a given release id', t => {
  const expected =
    'https://api.github.com/repos/nytm/trex-release-drafts/releases/9797693?access_token=MOCK_TOKEN'
